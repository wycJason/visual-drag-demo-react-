...
export default function changeComponentsSizeWithScale(scale) {
    ...
    store.setCurComponent(store.state, { component: componentData[store.state.curComponentIndex], index: store.state.curComponentIndex })
    store.setCanvasStyle(store.state, {
